...
class Trader:
    ...
    def get_best_orders(self, symbol: str, true_value: float, order_depth: OrderDepth, position: int) -> List[Order]:
        ...
        logger.print(f"Position Adjustment: {position_adjustment}")
        ...
        if desired_bid >= best_bid and desired_bid < true_value:
            ...
            logger.print(f"Adjusted Bid: {bid_price}")
        else:
        ...
        if desired_ask <= best_ask and desired_ask > true_value:
            ...
            logger.print(f"Adjusted Ask: {ask_price}")
        else:
        ...
        logger.print(f"Position Limit: {max_position}, Available Buy: {available_buy}, Available Sell: {available_sell}")
