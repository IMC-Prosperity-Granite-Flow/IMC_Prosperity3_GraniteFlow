...
class BasketStrategy(Strategy):
    ...
    def generate_orders(self, state: TradingState) -> Dict[Symbol, List[Order]]:
        ...
        pairing_amount1 = self.scale_pairing_amount(pairing_amount1, delta1, self.delta1_threshold,
                                                    self.max_delta1_range)
        pairing_amount2 = self.scale_pairing_amount(pairing_amount2, delta2, self.delta2_threshold,
                                                    self.max_delta2_range)
