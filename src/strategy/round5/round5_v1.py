    ...
    def generate_orders(self, state) -> List[Order]:
        ...
        if fair_value > self.open_price + 50:
            ...
            if available_sell > 0:
                ...
                orders.append(Order(self.symbol, best_bid, -math.ceil(sell_amt)))

        elif fair_value < self.open_price - 60:
            available_buy = 50 - current_position
            if available_buy > 0:
                buy_amt = min(-best_ask_amount, available_buy)
                orders.append(Order(self.symbol, best_ask, math.ceil(buy_amt)))
...
class BasketStrategy(Strategy):
    ...
    def generate_orders_jams(self, symbol: str, state: TradingState) -> List[Order]:
        ...
        elif fair_value < open_price_jams - 38:
